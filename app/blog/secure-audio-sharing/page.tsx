// app/blog/secure-audio-sharing/page.tsx
import Link from 'next/link';
import { FiArrowLeft } from 'react-icons/fi';
import styles from '../blog.module.css';

export default function SecureAudioSharingBlog() {
  return (
    <div className={styles.container}>
      <article className={styles.singlePost}>
        <header className={styles.postHeader}>
          <div className={styles.postMeta}>
            <time>April 28, 2025</time> • <span>6 min read</span>
          </div>
          <h1>How to Store and Share High-Quality Audio Safely</h1>
        </header>

        {/* <img
          src="/blog/secure-sharing.jpg"
          alt="Secure audio sharing concept"
          className={styles.postFeaturedImage}
          onError={(e) => {
            e.currentTarget.src = "https://via.placeholder.com/1200x600?text=Secure+Audio+Sharing";
          }}
        /> */}
